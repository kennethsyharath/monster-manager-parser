...
let fileDat: string;
let statIds = ['strength', 'dexterity', 'constitution', 'intelligence', 'wisdom', 'charisma'];

beforeAll(() => {
  fileDat = fs.readFileSync(path.join(__dirname, './assets/BasicMonster.json'), { encoding: 'utf8' });
});
